...
def get_transform_npy(opt, params=None, grayscale=False, method=Image.BICUBIC, convert=True):
    transform_list = []
    if grayscale:
        transform_list.append(transforms.Grayscale(1))
    if 'fixsize' in opt.preprocess:
    ...
    if convert:
        ...
        if grayscale:
            ...
            transform_list += [transforms.Normalize((0.98955333 ,0.98787785 ,0.9909138), (0.00760474,0.01642076,0.0099248))]
