...
def save_images(webpage, visuals, image_path, aspect_ratio=1.0, width=256):
    ...
    Parameters:
        webpage (the HTML class) -- the HTML webpage class that stores these imaegs (see _html_.py for more details)
...
class Visualizer():
    ...
    def create_visdom_connections(self):
        ...
        # Keep behavior simple and cross-platform: inform user to start visdom manually
        msg = ('\n\nCould not connect to Visdom server.\n'
               'Please start it manually: `python -m visdom.server -p %d`\n' % self.port)
        print(msg)
    ...
    def display_current_results(self, visuals, epoch, save_result):
        ...
        if self.use_html and (save_result or not self.saved):  # save images to an HTML file if they haven't been saved.
            ...
            # update website
            webpage = _html_.HTML(self.web_dir, 'Experiment name = %s' % self.name, refresh=0)
